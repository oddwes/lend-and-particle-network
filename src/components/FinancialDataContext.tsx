...
import {fromEthDate} from "../utils/utils";
    ...
    return {
      ...
      userData: {
        ...
        [address]: {
          ...
          deposits: store.userData[address] ? [...store.userData[address].deposits] : []
        }
      }
    }
  }
  if (action.type === "ADD_LEND_POSITION") {
    ...
    return {
      ...
      userData: {
        ...store.userData,
        [address]: {
          borrows: store.userData[address] ? [...store.userData[address].borrows] : [],
